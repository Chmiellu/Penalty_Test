...
MODEL_SUMMARY_FILE = "model_summary_middle.txt"
...
if(TRAIN):
    ...
    plt.savefig('accuracy_plot_MIDDLE.png')  # Save the accuracy plot
    plt.close()
    ...
    plt.grid(True)
    plt.gca().xaxis.set_major_locator(ticker.MultipleLocator(2))  # Epochs go every 2
    plt.savefig('loss_plot_MIDDLE.png')  # Save the loss plot
    plt.close()
